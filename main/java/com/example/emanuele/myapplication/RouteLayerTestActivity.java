...
import static com.example.emanuele.myapplication.MapLayerTestActivity.toBitmap;
            ...
            public void onMapLoadSuccess() {
                ...
                markLayer.setMarkIsClickListener(new MarkLayer.MarkIsClickListener() {
                    ...
                    public void markIsClick(int num) {
                        PointF target = new PointF(marks.get(num).x, marks.get(num).y);//punto cliccato, quindi il punto di arrivo
                        List<Integer> routeList = MapUtils.getShortestDistanceBetweenTwoPoints
                                (marks.get(20), target, nodes, nodesContract);//marks.get20 è il nodo di partenza sostituire con la posizione del qr code
