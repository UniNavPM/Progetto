...
public final class TestData {
    ...
    public static List<PointF> getNodesList() {
        ...
        nodes.add(new PointF(222, 34));//0
        nodes.add(new PointF(268, 34));//1
        nodes.add(new PointF(314, 34));//2
        nodes.add(new PointF(359, 34));//3
        nodes.add(new PointF(406, 34));//4
        nodes.add(new PointF(455, 34));//5
        nodes.add(new PointF(500, 34));//6
        nodes.add(new PointF(547, 34));//7
        nodes.add(new PointF(590, 34));//8
        nodes.add(new PointF(630, 34));//9
        nodes.add(new PointF(229, 194));//10
        nodes.add(new PointF(268, 194));//11
        nodes.add(new PointF(314, 194));//12
        nodes.add(new PointF(359, 194));//13
        nodes.add(new PointF(406, 194));//14
        nodes.add(new PointF(455, 194));//15
        nodes.add(new PointF(500, 194));//16
        nodes.add(new PointF(547, 194));//17
        nodes.add(new PointF(590, 194));//18
        nodes.add(new PointF(630, 194));//19
        nodes.add(new PointF(425, 194));//20
