...
public class Position {
    ...
    private String edificioDest;
    private PointF edificioPosition;
    ...
    public void setEdificioDest(String edificioDest){this.edificioDest=edificioDest;}//edificio di destinazione
    public String getEdificioDest(){return this.edificioDest;}

    public void setEdificioPosition(PointF edificioPosition){this.edificioPosition=edificioPosition;}
    public PointF getEdificioPosition(){return this.edificioPosition;}
}
