...
public class QRCodeEdificio extends AppCompatActivity implements View.OnClickListener{
        ...
        if (result != null) {
            if (result.getContents() == null) {
                ...
                try {
                    ...
                    String piano=obj.getString("edificio");

                    p.setEdificioPosition(new PointF(Integer.valueOf(x),Integer.valueOf(y)));
                    p.setEdificioDest(piano);
                    finestra=new Intent(getApplicationContext(),NavigazioneEdificio.class);
